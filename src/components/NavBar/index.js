    ...
    return ( 
        <nav className={styles.navbar}>
            <div className={styles.navBrand}>
                <Link to="/">
                    <img className={styles.logo} src={logo} alt="MeroGuru Logo" />
                </Link>
            </div>
            <Input className={styles.navToggleCheckbox} id="nav-menu-toggle" type="checkbox" />
            ...
            <div className={styles.navMenu}>
                <ul className={styles.navItems}>
                    ...
                    <NavLink to="/action" activeClassName={styles.navLinkActive} className={styles.navLink}>
                        <li className={styles.navItem}>NEAT+ in Action</li>
                    </NavLink>
                    <NavLink to="/resource" activeClassName={styles.navLinkActive} className={styles.navLink}>
                        <li className={styles.navItem}>Resources and Support</li>
                    </NavLink>
