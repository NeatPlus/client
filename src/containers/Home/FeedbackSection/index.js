            ...
            <div className={styles.feedback}>
                <div className={styles.textSection}>
                    ...
                    <p className={styles.desc}>
                        ...
                        <a className={styles.descLink} target="_blank" rel="noreferrer" href="https://docs.google.com/forms/d/1yZ8Mz8jWQepk2DhGH13fKKNQ65QvUEPm7HoXq_uwJEw/viewform?edit_requested=true"> <Localize>NEAT+ user feedback form</Localize></a>. <Localize>All responses are confidential and anonymous.</Localize>
                    </p>
                    <p className={styles.desc}>
